        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(textBox1.Text) &&
                    ...
                    !string.IsNullOrWhiteSpace(textBox4.Text)) // Checking if all textboxes are filled
                {
                    ...
                    // Checking if the amount entered in textBox4 matches the total amount
                    ...
                    if (enteredAmount == totalAmount)
                    {
                        ...
                        MessageBox.Show("Your payment has been processed successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
